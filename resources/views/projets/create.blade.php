                    ...
                    <div class="card-body">
                        <form action="{{ route('projets.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="technologie1" name="technologie1" value="{{ old('technologie1') }}">
                            </div>

                            <div class="mb-3">
                                <label for="technologie2" class="form-label">Technologie 2</label>
                                <input type="text" class="form-control" id="technologie2" name="technologie2" value="{{ old('technologie2') }}">
                            </div>

                            <div class="mb-3">
                                <label for="technologie3" class="form-label">Technologie 3</label>
                                <input type="text" class="form-control" id="technologie3" name="technologie3" value="{{ old('technologie3') }}">
                            </div>
