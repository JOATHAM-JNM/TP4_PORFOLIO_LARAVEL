...
<body>
    ...
    <header class="B">
        <div class="A">
            <div class="logo">
                    <img src="{{ asset('photos/logo.png') }}" alt="Mon Logo" class="D">
                </div>
            <nav class="E">
                <ul class="F">
    ...
    <section id="H" class="I">
        ...
        <div class="A">
            <div class="J">
                ...
                <div class="Q">
                    <img src="{{ asset('photos/profile.jpg') }}" alt="Ma photo" class="R">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="S" class="T">
        <div class="A">
            ...
            <div class="V">
                ...
                <div class="W">
                    <div class="X">
                        <img src="{{ asset('photos/' . $projet->image) }}" alt="{{ $projet->titre }}" class="Y">
                    </div>
                    <div class="Z">
                        <h3 class="AA">{{ $projet->titre }}</h3>
                        <p class="AB">
                            {{ $projet->description }}
                        </p>
                        <div class="AC">
                            @if($projet->technologie1)
                            <span class="AD">{{ $projet->technologie1 }}</span>
                            @endif
                            @if($projet->technologie2)
                            <span class="AD">{{ $projet->technologie2 }}</span>
                            @endif
                            @if($projet->technologie3)
                            <span class="AD">{{ $projet->technologie3 }}</span>
                            @endif
                        </div>
                    </div>
                </div>
    ...
    <footer class="BG">
        <div class="A">
            <div class="BH">
                ...
                <div class="BJ">
                    <a href="{{ route('messages.index') }}" class="BK">Messages</a>
                    <a href="{{ route('projets.index') }}" class="BK">Admin Projets</a>
