                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('projets.store')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="image" name="image" value="<?php echo e(old('image')); ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="technologie1" name="technologie1" value="<?php echo e(old('technologie1')); ?>">
                            </div>

                            <div class="mb-3">
                                <label for="technologie2" class="form-label">Technologie 2</label>
                                <input type="text" class="form-control" id="technologie2" name="technologie2" value="<?php echo e(old('technologie2')); ?>">
                            </div>

                            <div class="mb-3">
                                <label for="technologie3" class="form-label">Technologie 3</label>
                                <input type="text" class="form-control" id="technologie3" name="technologie3" value="<?php echo e(old('technologie3')); ?>">
                            </div>
...
<?php /**PATH D:\LARAVEL\portfolio\resources\views/projets/create.blade.php ENDPATH**/ ?>